...
def Mainmenu():
    ...
    Button(root, text="Scientific Calculator",bg="#505050", fg="#ffffff", width=200, anchor='center', command=scientific_calculator).pack(pady=10)
    Button(root, text="Graphic Calculator",bg="#505050", fg="#ffffff", width=200, anchor='center', command=graphic_calculator).pack(pady=10)
    Button(root, text="Statistics Calculator",bg="#505050", fg="#ffffff", width=200, anchor='center', command=statistics_calculator).pack(pady=10)
    Button(root, text="Calculus Calculator",bg="#505050", fg="#ffffff" , width=200, anchor='center',command=calculus_calculator).pack(pady=10)
    Button(root, text="Binomial Distribution",bg="#505050", fg="#ffffff", width=200, anchor='center',command=Binomial_Distribution).pack(pady=10)
    Button(root, text="Normal Distribution", bg="#505050", fg="#ffffff", width=200, anchor='center',command=Normal_Distribution).pack(pady=10)
    Button(root, text="Poisson Distribution",bg="#505050", fg="#ffffff",  width=200, anchor='center',command=Poison_Distribution).pack(pady=10)
